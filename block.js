            ...
            for(var j=0; j<this.field.y+1; j++){ 
                ...
                for(var k=0; k<this.field.z; k++ ){
                    ...
                    if( j == 0 ){
                        ...
                        if( j==0 && k==0 ){
                            ...
                            this.box[i][j][k].mesh.makeTranslation(
                                this.size * ( this.field.x - 1) / 2 + 1,
                                this.box[i][j][k].y,
                                this.size * ( this.field.z - 1)  /2 + 1
                            );
                           ...
                           THREE.GeometryUtils.merge(geom, this.box[i][j][k].mesh);
                        }
                        ...
                        */
                       this.box[i][0][k].mesh = new THREE.Mesh(new THREE.BoxGeometry(this.size, this.size * ( j+1 ) , this.size));
                       this.box[i][0][k].mesh.position.set(
                        this.box[i][0][k].x,
                        this.size * j/2 ,
                        this.box[i][0][k].z
                       );
                    ...
                    if( j == this.field.y-1 && this.box[i][1][k].exist ){   
                        ...
                        THREE.GeometryUtils.merge(geom, this.box[i][0][k].mesh);
                    }
